function [h,x,y,ii,jj] = read_sandwell(xi,yi);
% [h,x,y] = read_sandwell(xi,yi);
%
% Read the 1 minute Smith & Sandwell dataset to a regular grid that encompasses
% the end values of (XI,YI)
...
%nc=netcdf([DatasetDir '/Sandwell_14.1.nc'],'read');
nc=netcdf([DatasetDir '/Sandwell_global_14.1.nc'],'read');
